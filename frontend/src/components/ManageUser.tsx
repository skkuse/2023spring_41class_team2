                        ...
                        <tr>
                          ...
                          <td className = "span 2">
                            <div className=" row justify-content-around col" role="group">
                              <Button className="btn" variant="success" style={{ width: '30%', marginRight:'5px', marginLeft:'5px'}}>Info</Button> 
                              <Button className="btn" variant="success" style={{ width: '30%', marginRight:'5px'}}>Suspend</Button>
                              <Button className="btn" variant="danger" style={{ width: '30%', marginRight:'5px'  }}>Ban</Button>
                            </div>
                          </td>
                        </tr>
                        <tr>
