      ...
      <Container className="d-flex justify-content-center align-items-center" style={{ minHeight: '100vh' }}>
        <Row>
          <Col>
                  ...
                  <thead>
                    ...
                    <tbody>
                        <tr>
                          ...
                          <td >
                            <div className=" row justify-content-around col" role="group">
                              <Button className="btn" variant="success" style={{ width: '30%', marginRight:'5px', marginLeft:'5px'}}>Edit</Button> 
                              <Button className="btn" variant="success" style={{ width: '30%', marginRight:'5px'}}>Hide</Button>
                              <Button className="btn" variant="danger" style={{ width: '30%', marginRight:'5px'  }}>Delete</Button>
                            </div>
                          </td>
                        </tr>
                        <tr>
            ...
            <div className="text-center mb-4">
                <Button className="btn" variant="secondary" style={{ width: '100%', marginRight:'5px'  }}>Add New Problem</Button>
